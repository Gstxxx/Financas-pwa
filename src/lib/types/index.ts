 ...
 * Investments are illiquid holdings the user tracks manually. */
...
export interface Income {
  ...
  /** Optional FK to an Account when the income was added against a
   * specific wallet (manual entry from /accounts). */
  accountId?: string;
  createdAt: string;
}
